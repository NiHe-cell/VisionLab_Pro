...
QtObject {
    ...
    readonly property string settingsInference: zh ? "推理" : "Inference"
    readonly property string settingsLockedWhileRunning: zh ? "请先停止摄像头再改设置。" : "Stop the camera before changing settings."
    readonly property string liveStatus: zh ? "LIVE" : "LIVE"
    readonly property string pausedStatus: zh ? "已暂停" : "Paused"
    readonly property string windowMinimize: zh ? "最小化" : "Minimize"
    readonly property string windowMaximize: zh ? "最大化" : "Maximize"
    readonly property string windowClose: zh ? "关闭" : "Close"
